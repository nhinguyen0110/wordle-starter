...
class LetterCell: UICollectionViewCell {
  ...
  func set(style: LetterCellStyle) {
    // START YOUR CODE HERE
      switch style {
      case .initial:
          // Set background color to black and border color to gray
          contentView.backgroundColor = UIColor.black
          layer.borderColor = UIColor.gray.cgColor
      case .incorrect:
          // Set background and border color to RGBA(0.23, 0.23, 0.24, 1.0)
      ...
      case .correctLetterOnly:
          // Set background and border color to RGBA(0.69, 0.63, 0.30, 1.0)
      ...
      case .correctLetterAndPosition:
          // Set background and border color to RGBA(0.38, 0.55, 0.33, 1.0)
