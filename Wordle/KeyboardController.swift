...
class KeyboardController: NSObject,
  ...
  func collectionView(_ collectionView: UICollectionView,
    ...
    // START YOUR CODE HERE
      if section >= 0 && section < keyboardRows.count {
          // Return the count of items in the specified section.
  ...
  func collectionView(_ collectionView: UICollectionView,
    ...
    // START YOUR CODE HERE
        ...
        cell.didSelectString = { [weak self] selectedString in
          // Make sure to capture self weakly to avoid retain cycles
          
          // Call the didSelectString closure of the KeyboardController with the selected string.
